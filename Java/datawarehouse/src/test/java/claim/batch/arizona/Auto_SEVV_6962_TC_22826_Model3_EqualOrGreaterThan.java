...
public class Auto_SEVV_6962_TC_22826_Model3_EqualOrGreaterThan extends ImportBaseTest {
    private String[] listVisitKeys;

    @Test(groups = {"regression"})
    @QTest(keys = {"TC-22826", "TC-547"})
    public void Model3_EqualOrGreaterThan() throws Exception {
        //Prepare Environment
        ...
        for (ErrorAndRespCSVModel line : lineRecordInRespFile) {
            ...
            Assert.assertEquals(line.getRecordsFound().trim(), String.valueOf(listVisitKeys.length));
