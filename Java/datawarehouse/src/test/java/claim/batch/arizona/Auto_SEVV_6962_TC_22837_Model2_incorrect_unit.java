...
public class Auto_SEVV_6962_TC_22837_Model2_incorrect_unit extends ImportBaseTest {

    @Test(groups = {"regression"})
    @QTest(keys = {"TC-22837"})
    public void ExactMatchModel2() throws Exception {
        //Prepare Environment
        ...
        for (ErrorAndRespCSVModel line : lineRecordInRespFile) {
            ...
            Assert.assertEquals(line.getDetailsReason(), "Unmatched Units");
            Assert.assertEquals(line.getRecordsFound().trim(), "0");
        }
