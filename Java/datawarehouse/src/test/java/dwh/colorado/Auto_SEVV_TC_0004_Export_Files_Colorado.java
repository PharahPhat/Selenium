...
public class Auto_SEVV_TC_0004_Export_Files_Colorado extends V8VisitGenericTest{
    String testCaseId = "TC_0004";

    @Test
    public void Auto_SEVV_TC_0004_Export_Files_Colorado() {
        initStateInfo();
