...
public class Auto_SEVV_TC_0012_Export_Files_Hawaii extends V8VisitGenericTest{
    String testCaseId = "TC_0012";

    @Test
    public void Auto_SEVV_TC_0012_Export_Files_Hawaii() {
        initStateInfo();
