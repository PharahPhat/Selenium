...
import static com.sandata.common.Constant.PROVIDER_GENERAL;

public class Auto_SEVV_TC_0002_Export_Files_Molina extends V8VisitGenericTest {

    String testCaseId = "TC_0002";

    @Test(enabled = true, groups = {"All"})
    public void Auto_SEVV_TC_0002_Export_Files_Molina() {
        initStateInfo();
        ...
        logStepInfo("****  Check CLIENT_ELIG exported file exists in SFTP folder");
        verifyExportedFileExistInSFTP(CLIENT_ELIG);

        //Save File Name CLIENT_ELIG
        Assert.assertTrue(SavePreconditionData(testCaseId, "CLIENTELIG", fileName));

        logStepInfo("**** Download CLIENT_ELIG from SFTP to local machine");
