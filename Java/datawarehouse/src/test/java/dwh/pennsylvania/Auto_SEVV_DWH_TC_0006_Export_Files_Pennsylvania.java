...
public class Auto_SEVV_DWH_TC_0006_Export_Files_Pennsylvania extends V8VisitGenericTest {

    String testCaseId = "TC_0006";

    @Test
    public void Auto_SEVV_DWH_TC_0006_Export_Files_Pennsylvania() {
        initStateInfo();
