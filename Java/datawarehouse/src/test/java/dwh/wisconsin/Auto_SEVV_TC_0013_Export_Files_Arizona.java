...
public class Auto_SEVV_TC_0013_Export_Files_Arizona extends V8VisitGenericTest {
    String testCaseId = "TC_0013";

    @Test
    public void Auto_SEVV_TC_0011_Export_Files_Arizona() {
        initStateInfo();
        ...
        logStepInfo("Step 11: Download VISIT_CLAIMST from SFTP to local machine");
        downloadExportedFile(VISIT_CLAIMST);

        logStepInfo("Step 22: Download CLIENT_AUTH from SFTP to local machine");
        verifyExportedFileExistInSFTP(CLIENT_AUTH);

        Assert.assertTrue(SavePreconditionData(testCaseId, "CLIENT_AUTH", fileName));
        ...
        Assert.assertTrue(SavePreconditionData(testCaseId, "CLIENT_DESIGNEE", fileName));
        ...
        logStepInfo("Step 11: Download CLIENT_SCHEDULE from SFTP to local machine");
