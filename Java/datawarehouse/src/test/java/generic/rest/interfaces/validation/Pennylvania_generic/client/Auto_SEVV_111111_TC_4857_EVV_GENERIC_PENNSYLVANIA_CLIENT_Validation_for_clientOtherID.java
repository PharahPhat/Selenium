...
public class Auto_SEVV_111111_TC_4857_EVV_GENERIC_PENNSYLVANIA_CLIENT_Validation_for_clientOtherID extends InterfacesGenericTest {
    @Test
    public void Auto_SEVV_111111_TC_4857_EVV_GENERIC_PENNSYLVANIA_CLIENT_Validation_for_clientOtherID() {
        ...
        boolean result1 =  altEVV_Generic_Pennsylvania_client.ClientOtherID(Constant.DataType.userInput,0 ,"167834", true);

        boolean result2 =  altEVV_Generic_Pennsylvania_client.ClientOtherID(Constant.DataType.userInput,0 ,null, true);
