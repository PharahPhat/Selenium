...
public class Auto_SEVV_18404_TC_18485_Import_Base_auth_having_AuthEndDate_equal_AuthStartDate extends ImportBaseTest {
    ...
    public void Auto_SEVV_18404_TC_18485_Import_auth_having_AuthEndDate_equal_AuthStartDate() throws IOException, InterruptedException, SftpException, IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchAlgorithmException, KeyManagementException, URISyntaxException, TimeoutException, NoSuchFieldException, SQLException {
        ...
        authInfo.setAuthorizationStartDate(baseObj.getCurrentDate_DDMMYYYY());
        authInfo.setAuthorizationEndDate(baseObj.getCurrentDate_DDMMYYYY());
