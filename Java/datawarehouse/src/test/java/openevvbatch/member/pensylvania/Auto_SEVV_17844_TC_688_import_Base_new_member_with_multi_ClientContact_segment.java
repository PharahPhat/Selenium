...
public class Auto_SEVV_17844_TC_688_import_Base_new_member_with_multi_ClientContact_segment extends ImportBaseTest {
    ...
    @QTest(keys = {"TC-688"})
    public void TC_688_import_new_member_with_multi_ClientContact_segment() throws Exception {
        ...
        memberCSVModel1.setClientContactFirstName(Wrapper.generateRandomString(10));
        memberCSVModel1.setClientContactLastName(Wrapper.generateRandomString(10));

        memberCSVModel2.setClientOtherID(clientOtherID);
        memberCSVModel2.setSegmentName("ClientContact");
        memberCSVModel2.setClientContactFirstName(Wrapper.generateRandomString(10));
        memberCSVModel2.setClientContactLastName(Wrapper.generateRandomString(10));
        ...
        baseObj.info("Step 4.1: Verify number element of client contact on rabbitMQ");
        ...
        client_contacts = ClientMySqlDBServices.getClientContRecords(clientOtherID, "60130", "EC");
