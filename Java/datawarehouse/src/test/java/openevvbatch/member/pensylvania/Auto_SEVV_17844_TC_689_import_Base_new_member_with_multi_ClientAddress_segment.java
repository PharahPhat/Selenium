...
public class Auto_SEVV_17844_TC_689_import_Base_new_member_with_multi_ClientAddress_segment extends ImportBaseTest {
    ...
    @QTest(keys = {"TC-689"})
    public void TC_689_import_new_member_with_multi_ClientAddress_segment() throws Exception {
        ...
        memberCSVModel1.setClientAddressLine1(Wrapper.generateRandomString(10));
        memberCSVModel1.setClientAddressLine2(Wrapper.generateRandomString(10));
        ...
        client_addresses = ClientMySqlDBServices.getClientAddrRecords(clientOtherID, "60130");
        Assert.assertEquals(client_addresses.size(), listMembers.size());
    }
}
