...
public class Auto_SEVV_6951_TC_22082_HI_E2E_Flow_Import_Base_Provider extends ImportBaseTest {
    ImportProviderService importProviderService;


    @Test(groups = {"regression"})
    @QTest(keys = {"TC-22082"})
    public void TC_22082_HI_E2E_Flow_Import_Base_Provider() throws InterruptedException, SftpException, IOException, SQLException, InvocationTargetException, IllegalAccessException, NoSuchAlgorithmException, KeyManagementException, URISyntaxException, InstantiationException, TimeoutException, NoSuchFieldException {
