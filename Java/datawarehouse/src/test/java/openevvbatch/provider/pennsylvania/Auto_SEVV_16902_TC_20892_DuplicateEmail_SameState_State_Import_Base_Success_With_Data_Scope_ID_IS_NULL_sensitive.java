...
public class Auto_SEVV_16902_TC_20892_DuplicateEmail_SameState_State_Import_Base_Success_With_Data_Scope_ID_IS_NULL_sensitive extends ImportBaseTest {
    ImportProviderService importProviderService;

    @Test(groups = {"non-regression"})
    public void DuplicateEmail_SameState_State_Import_Success_With_Data_Scope_ID_IS_NULL_sensitive() throws Exception {
        STXAppUser existedJVAdmin = getRecordJVAdminOfSpecificState(AccountTemplate.PENNSYLVANIA).get(0);
        String username = existedJVAdmin.getUSERNAME().toString().toUpperCase();
