...
public class Auto_SEVV_16902_TC_20893_DuplicateEmail_Different_DataScopeID_Different_State_Fail_to_import_Base_and_Error_messages_displays_sensitive extends ImportBaseTest {
    ...
    public void DuplicateEmail_Different_DataScopeID_Different_State_Fail_to_import_and_Error_messages_displays() throws Exception {
        ...
        providerInfo.setAgencyEmail(String.valueOf(existedJVAdmin.getUSERNAME()).toLowerCase());
