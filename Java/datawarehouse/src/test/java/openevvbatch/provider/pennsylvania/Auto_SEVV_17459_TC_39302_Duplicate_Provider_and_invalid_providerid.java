...
public class Auto_SEVV_17459_TC_39302_Duplicate_Provider_and_invalid_providerid extends ImportBaseTest {

    ImportProviderService importProviderService;

    @Test(groups = {"non-regression"})
    public void TC_39302_Duplicate_Provider_and_invalid_providerid() throws Exception {
        ...
        providerInfo3.setProviderID(providerID + baseObj.generateRandomNumberObsolete(5));
        ...
        importProviderService.verifyRecordCountInboundFile("2", "1", inboundFileName);
    }
}
