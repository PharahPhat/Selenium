...
public class Auto_SEVV_TC_28000_Import_Base_Provider_For_Molina extends ImportBaseTest {
    ImportProviderService importProviderService;

    @Test(groups = {"non-regression"})
    public void Import_Provider_For_Molina() throws InterruptedException, SftpException, IOException, InvocationTargetException, IllegalAccessException, InstantiationException, NoSuchFieldException {
        ...
        String payerID = ImportServices.config.getEnvironment("defaultPayerID");
        String providerName = "Automation" + providerID;
        ...
        providerInfo.setPayerID(payerID);
        ...
        Assert.assertEquals(providerInfoInSTX.get(0).getPROVIDER_NAME(), providerName);
