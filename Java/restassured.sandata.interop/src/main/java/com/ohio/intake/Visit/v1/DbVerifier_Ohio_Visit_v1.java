...
public class DbVerifier_Ohio_Visit_v1 extends BaseTest{

	DataBaseVerifier dataBaseVerifier=new DataBaseVerifier();
	Constant_SQL Constant_SQL=new Constant_SQL();
	DataGenerator_Ohio_Visit_v1 dataGenerator=new DataGenerator_Ohio_Visit_v1();

	@SuppressWarnings("unchecked")
	public void jsonAssert_OhioInboxPatientV1(JSONObject jsonObject_Map) throws InterruptedException, java.text.ParseException,  SQLException, InterruptedException, ClassNotFoundException, FileNotFoundException, IOException, ParseException
	{
	...
	public void jsonAssert_OhioStxStaffV1(JSONObject jsonObject_Map) throws InterruptedException, java.text.ParseException, ClassNotFoundException, SQLException
	{
		logger.log(LogStatus.INFO, "Validating DB response "); 
	...
	@SuppressWarnings("unchecked")
	public void jsonAssert_OhioinboxVisitV1(JSONObject jsonobject) throws InterruptedException, java.text.ParseException, SQLException, InterruptedException, ClassNotFoundException
	{
	...
	InterruptedException, ClassNotFoundException
		{
			...
			jsonAssert_OhioinboxVisitV1(jsonObject);
