...
import com.globalMethods.core.Assertion_DbVerifier; public class Bug88434_TC88642_AltEVV_ClientAddLine1_hash extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void Bug88434_TC88642_AltEVV_ClientAddLine1_hash_validation() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
		...
		jsonObjectAdd1.put("ClientAddressLine1",CommonMethods.generateRandomStringOfFixLength(5) + "#" + CommonMethods.generateRandomStringOfFixLength(7));
