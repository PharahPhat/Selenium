...
import com.globalMethods.core.Assertion_DbVerifier; public class R2201_TC96722_AltEVV_ClientContactType extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();


	// Validating valid altEVV ClientContact type with Family as value
	@Test(groups = {"All", "Regression"})
	@AdditionalInfo(module = "AltEVVclient")
	public void R2201_TC96722_AltEVV_ClientContactType_valid_Family_chars() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException, java.text.ParseException
	{
	...
	@Test(groups = {"All"})
	@AdditionalInfo(module = "AltEVVclient")
	public void R2201_TC96722_AltEVV_ClientContactType_invalid_other_than_spcified_value() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException
	{
