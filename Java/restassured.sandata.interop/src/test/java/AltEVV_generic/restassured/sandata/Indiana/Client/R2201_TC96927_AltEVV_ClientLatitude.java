...
public class R2201_TC96927_AltEVV_ClientLatitude extends BaseTest { 
	...
	public void R2201_TC96927_AltEVV_ClientAddressLatitudetude_Format_MoreThan_90() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException  
	{   
		// adding method name info via logger
		// logger = extent.startTest("R2201_TC96927_AltEVV_ClientAddressLatitudetude_Format_MoreThan_90");
	...
	@Test(groups = {"All"})
	@AdditionalInfo(module = "AltEVVclient")
	public void R2201_TC96927_AltEVV_ClientAddressLatitude_Format_lessthan90() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException, SQLException, ClassNotFoundException, java.text.ParseException  
	{   
		// adding method name info via logger
		// logger = extent.startTest("R2201_TC96927_AltEVV_ClientAddressLatitude_Format_lessthan90");
	...
	@AdditionalInfo(module = "AltEVVclient")
	public void R2201_TC96927_AltEVV_ClientAddressLatitude_Format_MaxLengthplusone() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException  
	{   
		// adding method name info via logger
		// logger = extent.startTest("R2201_TC96927_AltEVV_ClientAddressLatitude_Format_MaxLengthplusone");
	...
	@Test(groups = {"All"})
	@AdditionalInfo(module = "AltEVVclient")
	public void R2201_TC96927_AltEVV_ClientAddressLatitude_Format_Minus90() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException  
	{   
		// adding method name info via logger
		// logger = extent.startTest("R2201_TC96927_AltEVV_ClientAddressLatitude_Format_Minus90");
	...
	@Test(groups = {"All"})
	@AdditionalInfo(module = "AltEVVclient")
	public void R2201_TC96927_AltEVV_ClientAddressLatitude_Format_specialchars() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException  
	{   
		// adding method name info via logger
		// logger = extent.startTest("R2201_TC96927_AltEVV_ClientAddressLatitude_Format_specialchars");
		...
		String bodyAsString=CommonMethods.capturePostResponse_400(altEVVJsonArray,CommonMethods.propertyfileReader(globalVariables.altevv_clients));
