...
public class R2267_TC91105_AltEVV_ClientAddressType extends BaseTest {
	...
	@Test(groups = {"All"})
	public void R2267_TC91105_AltEVV_ClientAddressType_valid_AddressType_Under_ClientAddress_BUSINESS() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException, SQLException, ClassNotFoundException  
	{   
	...
	@Test(groups = {"All"})
	public void R2267_TC91105_AltEVV_ClientAddressType_invalid_AddressType_Under_ClientAddress() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException  
	{   
		// adding method name info via logger
	...
	@Test(groups = {"All"})
	public void R2267_TC91105_AltEVV_ClientAddressType_valid_AddressType_greterThan12() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException  
	{   
		// adding method name info via logger
	...
	@Test(groups = {"All"})
	public void R2267_TC91105_AltEVV_ClientAddressType_valid_AddressType_null() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException, SQLException  
	{   
		// adding method name info via logger
	...
	@Test(groups = {"All"})
	public void R2267_TC91105_AltEVV_ClientAddressType_valid_AddressType_blank() throws InterruptedException, java.text.ParseException,  FileNotFoundException, IOException, ParseException  
	{   
		// adding method name info via logger
