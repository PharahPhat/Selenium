...
public class R2267_TC91221_AltEVV_ClientZip extends BaseTest { 
	...
	@AdditionalInfo(module = "OpenEVV")
		public void R2267_TC91221_AltEVV_ClientZip_valid_5Digit() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_valid_5Digit_append_0000() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_valid_5Digit_append_4digit() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
		// logger = extent.startTest("R2267_TC91221_AltEVV_ClientZip_valid");
		logger.log(LogStatus.INFO, "validating valid altEVV client  having ClientZip"); 
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_Leading_space() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_trailing_space() throws InterruptedException, IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_Mid_space() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_leading_trailing_space() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_SpecialChar() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_null_asvalue() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_null() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91221_AltEVV_ClientZip_invalid_blank() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
