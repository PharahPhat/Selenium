...
public class R2267_TC91253_AltEVV_ClientContactAddressLine1 extends BaseTest {
	...
	public void R2267_TC91253_AltEVV_ClientContactAddressLine1_valid_with_30char_asstring() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
		...
		jsonObject1.put("ClientContactAddressLine1", CommonMethods.generateRandomAlphaNumeric(30));
	...
	@Test(groups = {"All", "fixing"})
	public void R2267_TC91253_AltEVV_ClientContactAddressLine1_invalid_with_maxstring() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ClassNotFoundException, SQLException
	{
		...
		jsonObject1.put("ClientContactAddressLine1", CommonMethods.generateRandomAlphaNumeric(35));
	...
	@Test(groups = {"All"})
	public void R2267_TC91253_AltEVV_ClientContactAddressLine1_invalid_with_30char_specialchar() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
		...
		CommonMethods.verifyjsonassertFailcase(bodyAsString, globalVariables.ClientContactAddressLine1FormatRegularExpressionError);
	}

	//validating invalid altEVV client having ClientContactAddressLine1 with more than 30char with special character
	@Test(groups = {"All"})
	public void R2267_TC91253_AltEVV_ClientContactAddressLine1_invalid_with_morethan_30char_specialchar() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ClassNotFoundException, SQLException
	{
