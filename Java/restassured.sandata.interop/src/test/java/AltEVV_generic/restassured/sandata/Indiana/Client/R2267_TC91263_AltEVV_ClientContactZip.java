...
public class R2267_TC91263_AltEVV_ClientContactZip extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();


	//validating valid altEVV ClientContactZip validation field formats/values with 5 digit
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_valid_5Digit() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_valid_5Digit_append_0000() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_valid_5Digit_append_4digit() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
		// logger = extent.startTest("R2267_TC91263_AltEVV_ClientContactZip_valid");
		logger.log(LogStatus.INFO, "validating valid altEVV client  havingClientContactZip "); 
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_invalid_Leading_space() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_invalid_trailing_space() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_invalid_Mid_space() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_invalid_leading_trailing_space() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_invalid_SpecialChar() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_invalid_null_asvalue() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_valid_null() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException, ClassNotFoundException
	{
		// logger = extent.startTest("R2267_TC91263_AltEVV_ClientContactZip_valid_null");
	...
	@Test(groups = {"All"})
	public void R2267_TC91263_AltEVV_ClientContactZip_invalid_blank() throws InterruptedException, java.text.ParseException,  IOException, ParseException
	{
		...
		JSONArray jsonArray1 = (JSONArray) jsonObject.get(globalVariables.ClientResponsibleParty);
		JSONObject jsonObject1 = (JSONObject) jsonArray1.get(0);
		jsonObject1.put(globalVariables.ClientContactZip, "");
