...
import com.globalMethods.core.Assertion_DbVerifier; public class R679_TC88834_AltEVV_ClientStatus_invalid extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();


	//validating valid altEVV client  having PayerID_valid of Max Length i.e 64 char
	@Test(groups = {"All"})
	public void R679_TC88827_AltEVV_ClientStatus_null_invalid_fixed() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException
	{
	...
	@Test(groups = {"All"})
	public void R679_TC88827_AltEVV_ClientStatus_null_invalid_randoml() throws InterruptedException, java.text.ParseException,  IOException, ParseException, SQLException
	{
