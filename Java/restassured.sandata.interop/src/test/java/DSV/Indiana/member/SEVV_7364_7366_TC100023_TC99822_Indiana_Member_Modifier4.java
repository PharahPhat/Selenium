...
public class SEVV_7364_7366_TC100023_TC99822_Indiana_Member_Modifier4 extends BaseTest{
    ...
    public void SEVV_7364_TC_100023_Indiana_Member_Modifiers_Vlaid() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7364_TC_100023_Indiana_Member_Modifiers_Vlaid");
		...
		fileUpdateValue.put("Modifier4", CommonMethods.generateRandomStringOfFixLength(2));
	...
	@Test(enabled = true, groups = {"All", "Regression"})
    public void SEVV_7364_7366_TC100023_TC99822_Indiana_Member_Modifiers_blank() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7364_7366_TC100023_TC99822_Indiana_Member_Modifiers_blank");
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		Map<String ,String> finalMapapdataByRow = new HashMap<>();
		Map<String ,String> mapOutboundData = new HashMap<>();
