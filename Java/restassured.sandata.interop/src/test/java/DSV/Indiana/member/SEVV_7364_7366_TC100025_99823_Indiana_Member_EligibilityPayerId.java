...
public class SEVV_7364_7366_TC100025_99823_Indiana_Member_EligibilityPayerId extends BaseTest{
    ...
    public void SEVV_7364_7366_TC100025_99823_Indiana_Member_EligibilityPayerId() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7364_7366_TC100025_99823_Indiana_Member_EligibilityPayerId");
		...
		fileUpdateValue.put("EligibilityPayerID", CommonMethods.generateRandomStringOfFixLength(64));
	...
	@Test(enabled = true, groups = {"All", "Regression"})
    public void SEVV_7364_TC100025_Indiana_Member_EligibilityPayerId_blank() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7364_TC100025_Indiana_Member_EligibilityPayerId_blank");
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		Map<String ,String> finalMapapdataByRow = new HashMap<>();
		Map<String ,String> mapOutboundData = new HashMap<>();
		...
		logger.log(LogStatus.INFO,"Creating map for required Field map");
		fileUpdateValue=GenerateUniqueParam.MemberParams_PipeDelimited();
		fileUpdateValue.put("EligibilityPayerID", "");
		logger.log(LogStatus.INFO,"create the PipeDeliminated File and Encrypt to GPG");
		FileName =FileContentReader.createPipeDelimFileAndConvertToGPG(globalVariables.indianaMemberGenericFile, fileUpdateValue,globalVariables.indianaGenericFileFormat,globalVariables.member,timeStamp);
