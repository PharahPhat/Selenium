...
public class SEVV_7364_TC100010_100011_Indiana_Member_ValidateClientId extends BaseTest implements Runnable{
    ...
    public void SEVV_7364_TC100010_Indiana_Member_ValidateClientId() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7364_TC_100010_Indiana_Member_ValidateClientId");
	...
	@Test(enabled = true, groups = {"All", "Regression"})
    public void SEVV_7364_TC100011_Indiana_Member_ValidateClientId_inValid() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7364_TC_100010_Indiana_Member_ValidateClientId");
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		Map<String ,String> finalMapapdataByRow = new HashMap<>();
		...
		logger.log(LogStatus.INFO,"Creating map for required Field map");
		fileUpdateValue=GenerateUniqueParam.MemberParams_PipeDelimited();
		fileUpdateValue.put(globalVariables.molinaClientId, CommonMethods.generateSpecialChar(4));
		logger.log(LogStatus.INFO,"create the PipeDeliminated File and Encrypt to GPG");
		FileName =FileContentReader.createPipeDelimFileAndConvertToGPG(globalVariables.indianaMemberGenericFile, fileUpdateValue,globalVariables.indianaGenericFileFormat,globalVariables.member,timeStamp);
