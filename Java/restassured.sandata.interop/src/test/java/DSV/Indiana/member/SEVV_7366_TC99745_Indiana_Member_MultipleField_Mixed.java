...
public class SEVV_7366_TC99745_Indiana_Member_MultipleField_Mixed extends BaseTest{
    ...
    public void SEVV_7366_TC_99744_Indiana_Member_MultipleField_Valid() throws InterruptedException, java.text.ParseException,  Exception{
		...
		mapUpdateFileData1.put("ClientPhone", CommonMethods.generateRandomStringOfFixLength(100));
		...
		mapOutboundData.put(FileName, "2");
		...
		for(String filevalue:fileNames){
			if((filevalue).contains("Inbound")){
				...
				CommonMethods.AssertEqualsAndPrintValuesString("2", controlFileData.get("\"RecordCount\"").replace("\"", ""), "Total Record Count");
