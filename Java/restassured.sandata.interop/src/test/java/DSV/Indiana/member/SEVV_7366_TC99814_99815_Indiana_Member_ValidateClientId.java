...
public class SEVV_7366_TC99814_99815_Indiana_Member_ValidateClientId extends BaseTest implements Runnable{
    ...
    public void SEVV_7366_TC_99814_Indiana_Member_ValidateClientId() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7366_TC_99814_Indiana_Member_ValidateClientId");
...
List<String> Errormessage = new ArrayList<String>();
		...
		fileUpdateValue.put(globalVariables.molinaClientId, "");
	...
	@Test(enabled = true, groups = {"All", "Regression"})
    public void SEVV_7366_TC_99815_Indiana_Member_ValidateClientId() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7366_TC_99815_Indiana_Member_ValidateClientId");
//////////////Variable declaration ///////////////////
Map<String ,String> mapUpdateFileData = new HashMap<>();
Map<String ,String> finalMapapdataByRow = new HashMap<>();
Map<String ,String> mapOutboundData = new HashMap<>();
...
List<String> Errormessage = new ArrayList<String>();
		logger.log(LogStatus.INFO,"Creating map for required Field map");
		fileUpdateValue=GenerateUniqueParam.MemberParams_PipeDelimited();
		fileUpdateValue.put(globalVariables.molinaClientId, CommonMethods.generateRandomStringOfFixLength(11));
		logger.log(LogStatus.INFO,"create the PipeDeliminated File and Encrypt to GPG");
		FileName =FileContentReader.createPipeDelimFileAndConvertToGPG(globalVariables.indianaMemberGenericFile, fileUpdateValue,globalVariables.indianaGenericFileFormat,globalVariables.member,timeStamp);
		...
		Errormessage.add(globalVariables.ClientID_Error_member);
