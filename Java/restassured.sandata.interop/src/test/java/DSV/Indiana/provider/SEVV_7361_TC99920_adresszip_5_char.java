...
public class SEVV_7361_TC99920_adresszip_5_char extends BaseTest{
	...
	@AdditionalInfo(module = "OpenEVV")
	 ...
	 public void SEVV_7631_TC99920_adresszip_5_char_valid() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_7631_TC99920_adresszip_5_char_valid");
	...
	fileUpdateValue.put(globalVariables.AddressZip,CommonMethods.generateRandomNumberOfFixLength(5));
	fileUpdateValue.put("AgencyEmail","raviranjanbabasandata123@member.com");
