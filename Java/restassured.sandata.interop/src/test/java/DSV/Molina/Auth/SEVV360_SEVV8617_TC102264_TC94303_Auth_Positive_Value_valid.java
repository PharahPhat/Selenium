...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV360_SEVV8617_TC102264_TC94303_Auth_Positive_Value_valid extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV360_SEVV8617_TC102264_TC94303_Auth_Positive_Value_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV360_SEVV8617_TC102264_TC1173_Auth_Positive_Value_valid");
