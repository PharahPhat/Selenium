...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94307_Auth_Minimum_Value extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94305_Auth_Maximum_Value_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94305_Auth_Maximum_Value_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited_MinValue();
