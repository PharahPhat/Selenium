...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94309_Auth_PayerID_NULL extends BaseTest {
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94309_Auth_PayerID_NULL_valid() throws InterruptedException, java.text.ParseException, Exception {

		// logger = extent.startTest("SEVV_360_TC94309_Auth_PayerID_NULL_valid");
