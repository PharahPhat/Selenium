...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94322_Auth_PayerID_null extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@AdditionalInfo(module = "OpenEVV")
		public void SEVV_360_TC94322_Auth_PayerID_null_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94322_Auth_PayerID_null_valid");
