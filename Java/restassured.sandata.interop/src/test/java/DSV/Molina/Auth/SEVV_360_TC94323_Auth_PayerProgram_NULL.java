...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94323_Auth_PayerProgram_NULL extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94323_Auth_ClientQualifier_AS_ClientSSN_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8598_Auth_ClientQualifier_AS_ClientSSN_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("clientQualifier", "ClientSSN");
