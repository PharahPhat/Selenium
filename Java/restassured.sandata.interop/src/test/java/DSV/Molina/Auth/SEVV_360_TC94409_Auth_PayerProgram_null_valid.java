...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94409_Auth_PayerProgram_null_valid extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94409_Auth_PayerProgram_null_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8595_Auth_PayerProgram_null_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("payerProgram", "null");
