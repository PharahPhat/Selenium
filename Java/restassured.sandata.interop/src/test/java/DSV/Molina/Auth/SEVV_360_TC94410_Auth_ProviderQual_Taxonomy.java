...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94410_Auth_ProviderQual_Taxonomy extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_360_TC94410_Auth_ProviderQual_Taxonomy() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8621_Auth_ProviderQual_Taxonomy_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put(globalVariables.molinaProviderQualifier, "Taxonomy");
