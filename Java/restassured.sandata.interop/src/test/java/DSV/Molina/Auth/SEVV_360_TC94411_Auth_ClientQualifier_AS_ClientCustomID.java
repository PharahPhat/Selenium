...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94411_Auth_ClientQualifier_AS_ClientCustomID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94411_Auth_ClientQualifier_AS_ClientCustomID() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94410_Auth_ClientQualifier_AS_ClientCustomID_valid");
