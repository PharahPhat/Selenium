...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94413_Auth_ProviderQual_SandataID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_360_TC94413_Auth_ProviderQual_SandataID() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV_360_TC8608_Auth_ProviderQual_SandataID");
		...
		fileUpdateValue.put(globalVariables.molinaProviderQualifier, "SandataID");
