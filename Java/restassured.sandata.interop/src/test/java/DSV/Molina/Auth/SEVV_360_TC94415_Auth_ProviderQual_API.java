...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94415_Auth_ProviderQual_API extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_360_TC94415_Auth_ProviderQual_API() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8613_Auth_ProviderQual_API_valid");
