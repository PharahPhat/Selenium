...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94416_Auth_ProviderQual_MedicaidID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94416_Auth_ProviderQual_MedicaidID() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8615_Auth_ProviderQual_MedicaidID_Valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put(globalVariables.molinaProviderQualifier, "MedicaidID");
