...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94417_Auth_ProviderQual_TaxID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_360_TC94417_Auth_ProviderQual_TaxID() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8618_Auth_ProviderQual_TaxID_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put(globalVariables.molinaProviderQualifier, "TaxID");
