...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94418_Auth_ClientQualifier_AS_ClientOtherID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94418_Auth_ClientQualifier_AS_ClientOtherID() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8600_Auth_ClientQualifier_AS_ClientOtherID_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("clientQualifier", "ClientOtherID");
