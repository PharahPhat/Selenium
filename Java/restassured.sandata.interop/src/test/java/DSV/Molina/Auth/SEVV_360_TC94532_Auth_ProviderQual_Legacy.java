...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94532_Auth_ProviderQual_Legacy extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94532_Auth_ProviderQual_Legacy() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94418_Auth_ProviderQual_Taxonomy_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put(globalVariables.molinaProviderQualifier, "Legacy");
