...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94534_Auth_ProviderID_as_ProviderQualifier extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94534_Auth_ProviderID_as_ProviderQualifier() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94533_Auth_ProviderQual_Other_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("providerId", "providerQualifier");
