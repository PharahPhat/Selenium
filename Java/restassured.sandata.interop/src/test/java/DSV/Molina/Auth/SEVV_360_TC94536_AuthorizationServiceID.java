...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94536_AuthorizationServiceID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94536_AuthorizationServiceID() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8652_AuthorizationServiceID_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("authorizationServiceID", CommonMethods.generateRandomNumberOfFixLength(4)); 
