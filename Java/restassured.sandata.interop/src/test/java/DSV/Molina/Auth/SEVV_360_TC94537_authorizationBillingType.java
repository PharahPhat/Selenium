...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_360_TC94537_authorizationBillingType extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94536_AuthorizationServiceID_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94536_AuthorizationServiceID_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("authorizationBillingType", CommonMethods.generateRandomNumberOfFixLength(63)); 
