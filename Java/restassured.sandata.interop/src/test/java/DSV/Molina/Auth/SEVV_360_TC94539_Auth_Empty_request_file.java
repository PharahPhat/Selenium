...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94539_Auth_Empty_request_file extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94539_Auth_Empty_request_file_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94539_Auth_Empty_request_file_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.remove("payerID");
		fileUpdateValue.remove("authorizationLimitType"); 
