...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC94540_Auth_missing_Field extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94540_Auth_missing_Field_invalid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8660_Auth_missing_Field_invalid");
