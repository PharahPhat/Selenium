...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94546_Auth_AuthorizationLimitType_Field extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94546_Auth_AuthorizationLimitType_Field_Valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8666_Auth_AuthorizationLimitType_Field_Valid");
