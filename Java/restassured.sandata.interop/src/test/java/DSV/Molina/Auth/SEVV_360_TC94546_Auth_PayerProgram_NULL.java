...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94546_Auth_PayerProgram_NULL extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94546_Auth_PayerProgram_NULL_valid() throws Exception{
		
		// logger = extent.startTest("SEVV_360_TC94546_Auth_PayerProgram_NULL_valid");
