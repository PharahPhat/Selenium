...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94547_Auth_AuthorizationStatus_Field extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94547_Auth_AuthorizationStatus_Field_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC8669_Auth_AuthorizationStatus_Field_valid");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("authorizationStatus", "A"); 
