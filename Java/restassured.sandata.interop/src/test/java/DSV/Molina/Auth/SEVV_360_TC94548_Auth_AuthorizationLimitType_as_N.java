...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_360_TC94548_Auth_AuthorizationLimitType_as_N extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94548_Auth_AuthorizationLimitType_as_N_valid() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV_360_TC94548_Auth_AuthorizationLimitType_as_N_valid");
		...
		fileUpdateValue.put("authorizationLimitStartTime", null); 
		fileUpdateValue.put("authorizationLimitEndTime", null); 
