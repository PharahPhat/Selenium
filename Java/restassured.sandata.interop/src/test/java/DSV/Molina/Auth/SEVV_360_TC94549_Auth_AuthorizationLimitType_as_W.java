...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_360_TC94549_Auth_AuthorizationLimitType_as_W extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94548_Auth_AuthorizationLimitType_as_W_Valid() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV_360_TC94548_Auth_AuthorizationLimitType_as_W_Valid");
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94548_Auth_AuthorizationLimitType_as_W_invalid_blank() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV_360_TC94548_Auth_AuthorizationLimitType_as_W_invalid_blank");
		Map<String ,String> fileUpdateValue = new HashMap<>();
		String fileName;
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		...
		Errormessage.add(globalVariables.AuthauthorizationWeekStartNullError);
