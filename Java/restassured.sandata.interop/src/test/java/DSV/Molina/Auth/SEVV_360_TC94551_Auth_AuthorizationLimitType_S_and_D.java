...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_360_TC94551_Auth_AuthorizationLimitType_S_and_D extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94551_Auth_AuthorizationLimitType_S_Valid() throws InterruptedException, java.text.ParseException,  Exception{
		...
		fileUpdateValue.put("authorizationLimitDayOfWeek", CommonMethods.AuthWeekStartType()); 
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94550_Auth_AuthorizationLimitType_S_invalid() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV_360_TC94550_Auth_AuthorizationLimitType_S_invalid");
		Map<String ,String> fileUpdateValue = new HashMap<>();
		String fileName;
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		...
		Errormessage.add(globalVariables.AuthorizationLimitDayOfWeekNullError);
