...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV_360_TC94553_Auth_AuthorizationLimitType_D extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
@Test(groups = {"All"})
public void SEVV_360_TC94553_Auth_AuthorizationLimitType_D_Valid() throws InterruptedException, java.text.ParseException,  Exception{
...
@Test(groups = {"All"})
public void SEVV_360_TC94553_Auth_AuthorizationLimitType_D_inValid() throws InterruptedException, java.text.ParseException,  Exception{
...
@Test(groups = {"All"})
public void SEVV_360_TC94553_Auth_AuthorizationLimitType_D_valid_null() throws InterruptedException, java.text.ParseException,  Exception{
...
@Test(groups = {"All"})
public void SEVV_360_TC94553_Auth_AuthorizationLimitType_D_valid_blank() throws InterruptedException, java.text.ParseException,  Exception{
	...
	fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
	fileUpdateValue.put("authorizationLimitType", "D"); 
	fileUpdateValue.put("authorizationLimitStartTime", ""); 
