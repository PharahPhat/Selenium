...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_360_TC94554_Auth_AuthorizationLimitType_S extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94554_Auth_AuthorizationLimitType_S_Valid() throws InterruptedException, java.text.ParseException,  Exception{
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94554_Auth_AuthorizationLimitType_S_valid_null() throws InterruptedException, java.text.ParseException,  Exception{
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC94554_Auth_AuthorizationLimitType_S_valid_blank() throws InterruptedException, java.text.ParseException,  Exception{
