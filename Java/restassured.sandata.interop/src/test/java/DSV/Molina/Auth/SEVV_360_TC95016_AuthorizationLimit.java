...
import com.globalMethods.core.Assertion_DbVerifier; 
public class SEVV_360_TC95016_AuthorizationLimit extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(groups = {"All"})
	public void SEVV_360_TC95016_AuthorizationLimit() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV_360_TC95016_AuthorizationLimit");

		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited();
		fileUpdateValue.put("authorizationLimit", CommonMethods.generateRandomNumberOfFixLength(2)); 
