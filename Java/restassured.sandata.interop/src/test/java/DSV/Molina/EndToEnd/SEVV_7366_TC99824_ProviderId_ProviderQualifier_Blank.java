...
public class SEVV_7366_TC99824_ProviderId_ProviderQualifier_Blank extends BaseTest

{
	...
	public void SEVV_7366_TC99824_ProviderId_ProviderQualifier_Blank() throws Exception
	{

		String Clientidentifer=CommonMethods.generateRandomNumberOfFixLength(10);
	
		// logger = extent.startTest("SEVV_7366_TC99824_ProviderId_ProviderQualifier_Blank");
		...
		authUpdateFileData.put("providerId","");
		authUpdateFileData.put("providerQualifier","");
		...
		if(MYSQL_Database_Verifier.executeQueryMySql(String.format(Constant_SQL.StatusCodeAuth, Clientidentifer)).equalsIgnoreCase("-2"))
		{
