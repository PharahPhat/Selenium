...
public class SEVV8612_TC101707_Member_Required_MultipleEntry extends BaseTest {
    ...
    public void TC101707_Member_Required_MultipleEntry() throws InterruptedException, java.text.ParseException,  Exception{
		
		// logger = extent.startTest("SEVV8612_TC101707_Member_Required_MultipleEntry");
...
//////////////Variable declaration ///////////////////
	...
	mapUpdateFileData1=GenerateUniqueParam.MemberParams_PipeDelimited_RequiredField();
	mapUpdateFileData2=GenerateUniqueParam.MemberParams_PipeDelimited_RequiredField();
	...
	mapMultipleEntry.add(mapUpdateFileData2);
		...
		FileName =FileContentReader.createPipeDelimFileAndConvertToGPGMultiple(globalVariables.molinaGenericFile, mapMultipleEntry,globalVariables.memberGenericFileName,globalVariables.member,timeStamp);
