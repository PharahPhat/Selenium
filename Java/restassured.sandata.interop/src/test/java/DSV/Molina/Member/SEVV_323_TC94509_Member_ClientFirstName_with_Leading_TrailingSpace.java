...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94509_Member_ClientFirstName_with_Leading_TrailingSpace extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94507_Member_ClientFirstName_valid() throws InterruptedException, java.text.ParseException,  Exception{
		...
		mapUpdateFileData.put(globalVariables.molinaClientFirstName, " "+CommonMethods.generateRandomStringOfFixLength(10));
	...
	@Test(enabled = true, groups = {"All"})
	public void SEVV_323_TC94507_Member_ClientFirstName_valid_TrailingSpace() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_323_TC94657_Member_Valid_ClientPhone");
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		Map<String ,String> finalMapapdataByRow = new HashMap<>();
