...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94545_Member_Valid_value_ClientEligibilityEndDate extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_323_TC94545_Member_Valid_value_ClientEligibilityEndDate() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_323_TC94545_Member_Valid_value_ClientEligibilityEndDate");
		...
		mapUpdateFileData.put("clientEligibilityDateEnd", CommonMethods.generatePastDate_YYYY_MM_dd());
