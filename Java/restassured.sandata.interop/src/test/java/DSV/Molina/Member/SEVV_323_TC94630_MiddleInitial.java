...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94630_MiddleInitial extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	String timeStamp; 
	...
	public void tearDown()
	{
	 ...
	 public void SEVV_323_TC94630_MiddleInitial_valid() throws InterruptedException, java.text.ParseException,  Exception{
		 // logger = extent.startTest("SEVV_323_TC94630_MiddleInitial_valid");
...
//////////////Variable declaration ///////////////////
		...
		mapUpdateFileData.put(globalVariables.molinaMiddleInitial, CommonMethods.generateRandomStringOfFixLength(1));
