...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94634_ClientLastName_MixData extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_323_TC94634_ClientLastName_MixData_Valid() throws InterruptedException, java.text.ParseException,  Exception{
		 // logger = extent.startTest("SEVV_323_TC94634_ClientLastName_MixData_Valid");
