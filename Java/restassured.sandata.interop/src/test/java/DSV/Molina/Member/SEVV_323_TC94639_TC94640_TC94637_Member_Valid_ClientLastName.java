...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94639_TC94640_TC94637_Member_Valid_ClientLastName extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94639_Member_ClientLastName_valid_LeadingSpace() throws InterruptedException, java.text.ParseException,  Exception{
	...
	@Test(enabled = true, groups = {"All"})
	public void SEVV_323_TC94639_Member_ClientLastName_leading_Trailing_space() throws InterruptedException, java.text.ParseException,  Exception{
	...
	@Test(enabled = true, groups = {"All"})
	public void SEVV_323_TC94640_Member_ClientLastName_Between_space () throws InterruptedException, java.text.ParseException,  Exception{
	...
	@Test(enabled = true, groups = {"All"})
	public void SEVV_323_TC94637_Member_ClientLastName_valid_Null() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_323_TC94637_Member_ClientLastName_valid_Null");
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		Map<String ,String> finalMapapdataByRow = new HashMap<>();
		Map<String ,String> mapOutboundData = new HashMap<>();
		...
		logger.log(LogStatus.INFO,"Creating map for required Field map");
		mapUpdateFileData=GenerateUniqueParam.MemberParams_PipeDelimited();
		mapUpdateFileData.put(globalVariables.molinaClientLastName, null);
		logger.log(LogStatus.INFO,"create the PipeDeliminated File and Encrypt to GPG");
		FileName =FileContentReader.createPipeDelimFileAndConvertToGPG(globalVariables.molinaGenericFile, mapUpdateFileData,globalVariables.memberGenericFileName,globalVariables.member,timeStamp);
