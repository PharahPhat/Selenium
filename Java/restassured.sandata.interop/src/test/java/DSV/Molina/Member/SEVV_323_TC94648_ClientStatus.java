...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94648_ClientStatus extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94648_ClientStatus_01() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_323_TC94648_ClientStatus_01");
		...
		mapUpdateFileData.put("clientStatus", "01");
