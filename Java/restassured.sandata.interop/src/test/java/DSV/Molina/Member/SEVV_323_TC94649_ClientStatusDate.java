...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94649_ClientStatusDate extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94649_ClientStatusDate_valid() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_323_TC94649_ClientStatusDate_valid");
		...
		mapUpdateFileData.put("clientStatusDate", CommonMethods.generateTodayDate_YYYY_MM_dd());
