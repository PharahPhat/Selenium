...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94657_Member_Valid_value_ClientPhone extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_323_TC94657_Member_Valid_ClientPhone() throws InterruptedException, java.text.ParseException,  Exception{
		...
		mapUpdateFileData.put("clientPhone", CommonMethods.generateRandomNumberOfFixLength(10));
