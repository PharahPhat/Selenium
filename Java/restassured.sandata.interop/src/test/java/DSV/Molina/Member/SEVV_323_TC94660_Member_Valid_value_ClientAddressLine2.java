...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94660_Member_Valid_value_ClientAddressLine2 extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94660_Member_Valid_value_ClientAddressLine2() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_323_TC94660_Member_Valid_value_ClientAddressLine2");
		...
		mapUpdateFileData.put("clientAddressLine2", CommonMethods.generateRandomStringOfFixLength(25));
