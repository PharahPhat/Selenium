...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94662_ClientSSN_InValid extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94662_ClientSSN_InValid_Alphabet() throws InterruptedException, java.text.ParseException,  Exception{
		...
		mapUpdateFileData.put(globalVariables.molinaClientSSN, CommonMethods.generateSpecialChar(5));
		...
		Errormessage.add("The ClientSSN format is incorrect. The record should satisfy this regular expression");
