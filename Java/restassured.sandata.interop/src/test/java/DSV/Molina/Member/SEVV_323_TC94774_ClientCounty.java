...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94774_ClientCounty extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94774_ClientCounty() throws Exception{
		// logger = extent.startTest("SEVV_323_TC94774_ClientCounty");
		...
		mapUpdateFileData.put("clientCounty", CommonMethods.generateRandomStringOfFixLength(25));
