...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_323_TC94776_ClientState extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
FileContentReader FileContentReader =new FileContentReader();
	...
	public void SEVV_323_TC94745_ClientCity() throws Exception{
		// logger = extent.startTest("SEVV_323_TC94745_ClientCity");
		...
		mapUpdateFileData.put("clientCity", CommonMethods.generateRandomStringOfFixLength(30));
