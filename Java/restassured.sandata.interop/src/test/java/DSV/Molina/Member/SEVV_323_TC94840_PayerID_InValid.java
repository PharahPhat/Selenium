...
public class SEVV_323_TC94840_PayerID_InValid extends BaseTest {
	...
	public void SEVV_323_TC94840_PayerID_InValid() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_323_TC94840_PayerID_InValid");
		...
		mapUpdateFileData.put("payerId", CommonMethods.generateRandomAlphaNumeric(65));
		...
		Errormessage.add("ERROR: The PayerID (Eligibility segment) length is invalid. The length should be between 1 and 64.");
