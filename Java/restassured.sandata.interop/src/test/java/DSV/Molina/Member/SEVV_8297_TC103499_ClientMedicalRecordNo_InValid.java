...
public class SEVV_8297_TC103499_ClientMedicalRecordNo_InValid extends BaseTest {
	...
	public void TC103499_ClientMedicalRecordNo_InValid() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC103499_ClientMedicalRecordNo_InValid");
		...
		mapUpdateFileData.put("ClientMedicalRecordNum", CommonMethods.generateRandomNumberOfFixLength(13));
		...
		Errormessage.add("ERROR: The ClientMedicalRecordNumber length is invalid. The length should be between 0 and 12.");
