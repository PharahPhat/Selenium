...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94888_Verify_maximum_Length_ProviderID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@AdditionalInfo(module = "OpenEVV")
	 ...
	 public void TC94888_Verify_maximum_Length_of_ProviderID() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC94888_Verify_maximum_Length_of_ProviderID");
	...
	fileUpdateValue.put(globalVariables.ProviderID,CommonMethods.generateRandomNumberOfFixLength(15));
