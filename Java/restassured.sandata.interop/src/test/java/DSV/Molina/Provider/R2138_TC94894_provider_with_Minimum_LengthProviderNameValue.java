...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94894_provider_with_Minimum_LengthProviderNameValue extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	fileUpdateValue.put(globalVariables.ProviderName,CommonMethods.generateRandomStringOfFixLength(1));
