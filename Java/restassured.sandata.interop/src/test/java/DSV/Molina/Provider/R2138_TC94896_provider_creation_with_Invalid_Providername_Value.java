...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94896_provider_creation_with_Invalid_Providername_Value extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void TC94896_provider_creation_with_Invalid_Providername_Value() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC94896_provider_creation_with_Invalid_Providername_Value");
	...
	fileUpdateValue.put(globalVariables.ProviderName,CommonMethods.generateRandomStringOfFixLength(31));
