...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94897_Verify_provider_with_Maximum_Length_ProviderName extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void TC94897_Verify_provider_with_Maximum_Length_ProviderName() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC94897_Verify_provider_with_Maximum_Length_ProviderName");
	...
	fileUpdateValue.put(globalVariables.ProviderName,CommonMethods.generateRandomStringOfFixLength(26));
