...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94898_Verify_with_Space_ProviderName extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void TC94898_Verify_provider_creation_with_Space_in_ProviderName() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC94898_Verify_provider_creation_with_Space_in_ProviderName");
	...
	fileUpdateValue.put(globalVariables.ProviderName,CommonMethods.generateRandomStringOfFixLength(10)+" " +CommonMethods.generateRandomStringOfFixLength(10));
