...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94912_Verify_Valid_AddressState_field extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void R2138_TC94912_Verify_Valid_AddressState_field_alphabet() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("R2138_TC94912_Verify_Valid_AddressState_field_alphabet");
