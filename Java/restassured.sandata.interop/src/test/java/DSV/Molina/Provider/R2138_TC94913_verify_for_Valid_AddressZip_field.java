...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94913_verify_for_Valid_AddressZip_field extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void TC94913_verify_for_Valid_AddressZip_field_9digit() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC94913_verify_for_Valid_AddressZip_field_9digit");
	...
	fileUpdateValue.put(globalVariables.AddressZip,CommonMethods.generateRandomNumberOfFixLength(9));
