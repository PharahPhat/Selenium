...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC94919_Verify_Valid_AgencyPhone extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	fileUpdateValue.put(globalVariables.AgencyPhone,CommonMethods.generateRandomNumberOfFixLength(10));
