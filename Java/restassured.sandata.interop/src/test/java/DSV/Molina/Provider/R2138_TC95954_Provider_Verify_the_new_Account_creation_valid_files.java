...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC95954_Provider_Verify_the_new_Account_creation_valid_files extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
		 ...
		 public void TC95954_Provider_Verify_the_new_Account_creation_valid_files() throws InterruptedException, java.text.ParseException,  Exception{
			// logger = extent.startTest("TC95954_Provider_Verify_the_new_Account_creation_valid_files");
