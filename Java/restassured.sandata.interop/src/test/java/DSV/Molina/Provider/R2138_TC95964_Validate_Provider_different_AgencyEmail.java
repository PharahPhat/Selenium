...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC95964_Validate_Provider_different_AgencyEmail extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
		 ...
		 public void TC95964_Validate_Provider_different_AgencyEmail() throws InterruptedException, java.text.ParseException,  Exception{
			// logger = extent.startTest("TC96210_verify_same_request_with_Different_providerID");
		...
		fileUpdateValue.put(globalVariables.molinaproviderEmail,CommonMethods.generateEmailAddress_alpha(5));
