...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96166_Verify_valid_file_name_Convention extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
		 ...
		 public void TC96166_Verify_valid_file_name_Convention() throws InterruptedException, java.text.ParseException,  Exception{
			 
			 // logger = extent.startTest("TC96166_Verify_valid_file_name_Convention");
