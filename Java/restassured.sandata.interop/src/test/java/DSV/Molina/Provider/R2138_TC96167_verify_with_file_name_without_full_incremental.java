...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96167_verify_with_file_name_without_full_incremental extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void TC96167_verify_with_file_name_without_full_incremental() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("TC96167_verify_with_file_name_without_full_incremental");
		...
		FileName = globalVariables.filenamewithoutfull;
		logger.log(LogStatus.INFO,"create the PipeDeliminated File and Encrypt to GPG");
