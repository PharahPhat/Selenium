...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96170_Verify_provider_creation_with_invalid_FileName extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void TC96170_Verify_provider_creation_with_invalid_FileName() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("TC96170_Verify_provider_creation_with_invalid_FileName");
		...
		FileName = "MEDHHS_EVV_Provider_20181023_15490.csv";
		logger.log(LogStatus.INFO,"create the PipeDeliminated File and Encrypt to GPG");
