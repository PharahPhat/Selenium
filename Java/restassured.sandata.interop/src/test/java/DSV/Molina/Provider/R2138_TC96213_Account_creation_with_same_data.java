...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96213_Account_creation_with_same_data extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
		 ...
		 public void TC96213_Account_creation_with_same_data() throws InterruptedException, java.text.ParseException,  Exception{
			// logger = extent.startTest("TC96213_Account_creation_with_same_data");
				System.out.println(globalVariables.genericfile+globalVariables.molinaProviderFileName);

//creating first data with new data set.
