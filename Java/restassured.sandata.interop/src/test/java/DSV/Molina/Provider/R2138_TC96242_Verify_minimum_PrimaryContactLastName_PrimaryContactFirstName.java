...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96242_Verify_minimum_PrimaryContactLastName_PrimaryContactFirstName extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@AdditionalInfo(module = "OpenEVV")
	 ...
	 public void TC96242_Verify_minimum_PrimaryContactLastName_PrimaryContactFirstName() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC96242_Verify_minimum_PrimaryContactLastName_PrimaryContactFirstName");
	...
	fileUpdateValue.put(globalVariables.PrimaryContactFirstName,CommonMethods.generateRandomStringOfFixLength(10));
