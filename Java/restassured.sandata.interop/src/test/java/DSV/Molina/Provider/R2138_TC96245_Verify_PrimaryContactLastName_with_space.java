...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96245_Verify_PrimaryContactLastName_with_space extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void TC96245_Verify_PrimaryContactLastName_with_space() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC96245_Verify_PrimaryContactLastName_with_space");
	...
	fileUpdateValue.put(globalVariables.PrimaryContactLastName,CommonMethods.generateRandomStringOfFixLength(8)+" "+ CommonMethods.generateRandomStringOfFixLength(8));
