...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96255_Verify_Maximum_Length_AgencyEmail extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void TC96255_Verify_Maximum_Length_AgencyEmail() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC96255_Verify_Maximum_Length_AgencyEmail");
	...
	fileUpdateValue.put(globalVariables.AgencyEmail,CommonMethods.generateEmailAddress_string(19));
