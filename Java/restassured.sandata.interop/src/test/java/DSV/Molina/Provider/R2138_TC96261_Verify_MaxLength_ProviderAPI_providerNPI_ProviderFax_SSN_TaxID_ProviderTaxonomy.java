...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96261_Verify_MaxLength_ProviderAPI_providerNPI_ProviderFax_SSN_TaxID_ProviderTaxonomy extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(enabled = true, groups = {"All"})
	 ...
	 public void TC96261_Verify_MaxLength_ProviderAPI_providerNPI_ProviderFax_SSN_TaxID_ProviderTaxonomy() throws InterruptedException, java.text.ParseException,  Exception{
	...
	fileUpdateValue.put(globalVariables.ProviderAPI,CommonMethods.generateRandomNumberOfFixLength(30));
	fileUpdateValue.put(globalVariables.ProviderNPI,CommonMethods.generateRandomNumberOfFixLength(10));
	fileUpdateValue.put(globalVariables.ProviderFax,CommonMethods.generateRandomNumberOfFixLength(10));
	fileUpdateValue.put(globalVariables.SSN,CommonMethods.generateRandomNumberOfFixLength(9));
	fileUpdateValue.put(globalVariables.TaxID,CommonMethods.generateRandomNumberOfFixLength(9));
