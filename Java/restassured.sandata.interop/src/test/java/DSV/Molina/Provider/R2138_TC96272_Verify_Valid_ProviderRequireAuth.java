...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96272_Verify_Valid_ProviderRequireAuth extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void tearDown()
	{
	 ...
	 public void TC96272_Verify_Valid_ProviderRequireAuth_1() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC96272_Verify_Valid_ProviderRequireAuth_1");
	...
	assertionDbVerifier.assertControlFileValid(fileNames,FileName,finalMapapdataByRow,outboundFileName,globalVariables.provider,timeStamp);
	 ...
	 public void TC96272_Verify_Valid_ProviderRequireAuth_blank() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC96272_Verify_Valid_ProviderRequireAuth_blank");
			System.out.println(globalVariables.genericfile+globalVariables.molinaProviderFileName);
