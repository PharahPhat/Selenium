...
import com.globalMethods.core.Assertion_DbVerifier; public class R2138_TC96286_Verify_Valid_Date_Format extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@AdditionalInfo(module = "OpenEVV")
	 ...
	 public void TC96286_Verify_Valid_Date_Format_for_ProviderDateBegin_ProviderDateEnd() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC96286_Verify_Valid_Date_Format_for_ProviderDateBegin_ProviderDateEnd");
	...
	fileUpdateValue.put(globalVariables.ProviderDateBegin,CommonMethods.generateFutureDate_YYYY_MM_dd());
	fileUpdateValue.put(globalVariables.ProviderDateEnd,CommonMethods.generateFutureDate_YYYY_MM_dd());
