...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV6926_R2138_TC96243_TC103551_Verify_Invalid_PrimaryContactLastName_PrimaryContactFirstName extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(enabled = true, groups = {"All"})
	 ...
	 public void TC103551_Verify_PrimaryContactLastName_PrimaryContactFirstName_Null() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC103551_Verify_PrimaryContactLastName_PrimaryContactFirstName_Null");
