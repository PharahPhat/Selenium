...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV6926_R2138_TC96244_TC103548_Verify_Maxlength_PrimaryContactLastName_PrimaryContactFirstName extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	@Test(enabled = true, groups = {"All"})
	 ...
	 public void TC103548_TC96244_Verify_Maxlength_of_PrimaryContactLastName_and_PrimaryContactFirstName() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC103548_TC96244_Verify_Maxlength_of_PrimaryContactLastName_and_PrimaryContactFirstName");
	...
	fileUpdateValue.put(globalVariables.PrimaryContactLastName,CommonMethods.generateRandomStringOfFixLength(30));
	fileUpdateValue.put(globalVariables.PrimaryContactFirstName,CommonMethods.generateRandomStringOfFixLength(30));
