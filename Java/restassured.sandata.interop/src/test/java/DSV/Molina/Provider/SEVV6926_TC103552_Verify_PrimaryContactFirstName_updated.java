...
import com.globalMethods.core.Assertion_DbVerifier;
public class SEVV6926_TC103552_Verify_PrimaryContactFirstName_updated extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
public void TC103552_Verify_PrimaryContactFirstName_updated() throws InterruptedException, java.text.ParseException,  Exception{
	// logger = extent.startTest("TC96243_Verify_Invalid_PrimaryContactLastName_PrimaryContactFirstName");
	...
	fileUpdateValue.put(globalVariables.PrimaryContactFirstName,CommonMethods.generateRandomStringOfFixLength(24));
