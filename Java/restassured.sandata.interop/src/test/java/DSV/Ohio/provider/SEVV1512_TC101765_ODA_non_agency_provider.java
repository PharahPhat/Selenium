...
public class SEVV1512_TC101765_ODA_non_agency_provider extends BaseTest {

	Assertion_DbVerifier_ohio_provider assertionDbVerifier =new Assertion_DbVerifier_ohio_provider();
	FileContentReader FileContentReader =new FileContentReader();
	//This test cases will be covered in SEVV10968
//	@Test(groups = {"All", "Regression"})
	public  void createData_test() throws InterruptedException, java.text.ParseException, Exception
	{
		...
		FieldsProvider.ProvTypeSpeciality = "71380";
