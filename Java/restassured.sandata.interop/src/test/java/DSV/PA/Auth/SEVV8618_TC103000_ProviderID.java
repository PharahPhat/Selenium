...
public class SEVV8618_TC103000_ProviderID extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV8618_TC103000_ProviderID_Valid() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV8618_TC103000_ProviderID_Valid");
		...
		fileUpdateValue.put(globalVariables.provideridohio, CommonMethods.generateRandomNumberOfFixLength(64)); 
	...
	@Test(enabled = true, groups = {"All"})
	public void SEVV8618_TC103000_ProviderID_InValid_Length() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV8618_TC103000_ProviderID_InValid_Length");
		Map<String ,String> fileUpdateValue = new HashMap<>();
		String fileName;
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		...
		List<String> Errormessage = new ArrayList<String>();
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited_PositveValue_Pensyl();
		fileUpdateValue.put(globalVariables.provideridohio, CommonMethods.generateRandomNumberOfFixLength(14)); 
	...
	@Test(enabled = true, groups = {"All"})
	public void SEVV8618_TC103000_ProviderID_InValid_Blank() throws InterruptedException, java.text.ParseException,  Exception{

		// logger = extent.startTest("SEVV8618_TC103000_ProviderID_InValid_Blank");
		Map<String ,String> fileUpdateValue = new HashMap<>();
		String fileName;
		//////////////Variable declaration ///////////////////
		Map<String ,String> mapUpdateFileData = new HashMap<>();
		...
		List<String> Errormessage = new ArrayList<String>();
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited_PositveValue_Pensyl();
		fileUpdateValue.put(globalVariables.provideridohio, ""); 
