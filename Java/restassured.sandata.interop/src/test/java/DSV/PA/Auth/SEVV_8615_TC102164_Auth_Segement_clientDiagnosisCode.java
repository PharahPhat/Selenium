...
public class SEVV_8615_TC102164_Auth_Segement_clientDiagnosisCode extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_8615_TC102164_Auth_Segement_clientDiagnosisCode() throws InterruptedException,  Exception{
		
		// logger = extent.startTest("SEVV_8615_TC102164_Auth_Segement_clientDiagnosisCode");
		
		fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited_PositveValue_Pensyl();
		fileUpdateValue.put("segmentName","clientDiagnosisCode");
