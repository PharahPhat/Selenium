...
public class SEVV_8615_TC102872_Auth_NonSegement extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void SEVV_8615_TC102872_Auth_NonSegement() throws InterruptedException,  Exception{
		
		// logger = extent.startTest("SEVV_8615_TC102872_Auth_NonSegement");
