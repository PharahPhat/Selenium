...
public class SEVV_8618_TC102994_Auth_PayerRegion_Invalid extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
public void TC102994_Auth_PayerRegion_Invalid_Blank() throws InterruptedException, java.text.ParseException,  Exception{

	// logger = extent.startTest("TC102994_Auth_PayerRegion_Invalid_Blank");
	...
	fileUpdateValue.put(globalVariables.PayerRegionAuth, ""); 
...
@Test(enabled = true, groups = {"All"})
public void TC102994_Auth_PayerRegion_Invalid_greaterThanMax() throws InterruptedException, java.text.ParseException,  Exception{

	// logger = extent.startTest("TC102994_Auth_PayerRegion_Invalid_greaterThanMax");
	Map<String ,String> fileUpdateValue = new HashMap<>();
	...
	List<String> Errormessage =new ArrayList<String>();
	fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited_PositveValue_Pensyl();
	fileUpdateValue.put(globalVariables.PayerRegionAuth, CommonMethods.generateRandomStringOfFixLength(3)); 
	...
	Errormessage.add(globalVariables.AuthorizationPayerRegion);
