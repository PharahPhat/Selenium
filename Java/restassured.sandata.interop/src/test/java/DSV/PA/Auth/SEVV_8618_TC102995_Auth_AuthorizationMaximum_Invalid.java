...
public class SEVV_8618_TC102995_Auth_AuthorizationMaximum_Invalid extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
...
public void TC102995_Auth_AuthorizationMaximum_Invalid_Blank() throws InterruptedException, java.text.ParseException,  Exception{

	// logger = extent.startTest("TC102995_Auth_AuthorizationMaximum_Invalid_Blank");
	...
	fileUpdateValue.put(globalVariables.AuthorizationMaximumAuth, ""); 
...
@Test(enabled = true, groups = {"All"})
public void TC102995_Auth_AuthorizationMaximum_Invalid_greaterThanMax() throws InterruptedException, java.text.ParseException,  Exception{

	// logger = extent.startTest("TC102995_Auth_AuthorizationMaximum_Invalid_greaterThanMax");
	Map<String ,String> fileUpdateValue = new HashMap<>();
	...
	List<String> Errormessage =new ArrayList<String>();
	fileUpdateValue=GenerateUniqueParam.AuthParams_PipeDelimited_PositveValue_Pensyl();
	fileUpdateValue.put(globalVariables.AuthorizationMaximumAuth, CommonMethods.generateRandomNumberOfFixLength(7)); 
