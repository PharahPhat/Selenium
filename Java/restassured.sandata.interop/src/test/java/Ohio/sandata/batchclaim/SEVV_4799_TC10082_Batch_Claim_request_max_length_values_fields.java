...
import com.globalMethods.core.Assertion_DbVerifier; public class SEVV_4799_TC10082_Batch_Claim_request_max_length_values_fields extends BaseTest { GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); Assertion_DbVerifier assertionDbVerifier =new Assertion_DbVerifier();
	...
	public void TC10082_Batch_Claim_request_max_length_values_fields() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("TC10082_Batch_Claim_request_max_length_values_fields");
    
		logger.log(LogStatus.INFO,"Generating unique parameters file");
	fileUpdateValue=GenerateUniqueParam.ohioclaim_PipeDelimited_maxlength();
