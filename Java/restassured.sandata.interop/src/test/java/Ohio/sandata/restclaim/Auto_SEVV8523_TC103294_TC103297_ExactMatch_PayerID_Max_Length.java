...
public class Auto_SEVV8523_TC103294_TC103297_ExactMatch_PayerID_Max_Length extends BaseTest{

	GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam();
	Assertion_DbVerifier Assertion_DbVerifier= new Assertion_DbVerifier();

	@Test(groups = {"All", "Regression", "fixing"})
	public void TC103294_TC103297_ExactMatch_PayerID_Max_Length() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException {

		// logger = extent.startTest("TC103294_TC103297_ExactMatch_PayerID_Max_Length");
