...
public class SEVV_4799_scenario_to_check_response_in_case_of_pass  extends BaseTest{

	GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam();
	Assertion_DbVerifier Assertion_DbVerifier= new Assertion_DbVerifier();

	@Test(groups = {"All", "Regression", "fixing"})
	public void SEVV_4799_scenario_to_check_response_in_case_of_pass_value() throws InterruptedException, java.text.ParseException,  Exception{
		// logger = extent.startTest("SEVV_4799_scenario_to_check_response_in_case_of_pass_value");
		...
		CommonMethods.CapterrestclaimResponse_inOut_time(claimSubobject,json2Object,json);
