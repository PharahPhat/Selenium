...
public class SEVV_TC002262_Model2_Multi_identical_visits_scenario extends BaseTest {
    ...
    public  void SEVV_TC002262_Model2_Multi_identical_visits_scenario(String value ) throws InterruptedException, IOException, ParseException, SQLException, java.text.ParseException, ClassNotFoundException {
        ...
        claimSubobject.put(globalVariables.ServiceStartDate, "2019-10-17");
        claimSubobject.put(globalVariables.ServiceEndDate, "2019-10-17");
        claimSubobject.put(globalVariables.ProcedureCode, "HPC");
        claimSubobject.put(globalVariables.Units, "08");
        ...
        for(int i = 0; i<bodyAsArray.size(); i++){
            ...
            Assert.assertEquals(visit.get("Details").toString(),"No Visit Found");
