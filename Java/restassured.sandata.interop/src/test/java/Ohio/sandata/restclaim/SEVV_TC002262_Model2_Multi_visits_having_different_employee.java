...
public class SEVV_TC002262_Model2_Multi_visits_having_different_employee extends BaseTest {
    ...
    public  void SEVV_TC002262_Model2_Multi_visits_having_different_employee(String value) throws InterruptedException, IOException, ParseException, SQLException, java.text.ParseException, ClassNotFoundException {
        ...
        claimSubobject.put(globalVariables.PatientID, "432356434567");
        claimSubobject.put(globalVariables.ServiceStartDate, "2019-11-18");
        claimSubobject.put(globalVariables.ServiceEndDate, "2019-11-18");
        claimSubobject.put(globalVariables.ProcedureCode, "HPC");
        claimSubobject.put(globalVariables.Units, "8.0");
        ...
        Assert.assertEquals(bodyAsArray.size(),2);
