...
public class SEVV_1214_TC96637_OhioV1_PatientAddressLine2_Validation extends BaseTest {
    ...
    public void TC96637_OhioV1_PatientAddressLine2_with_hash(boolean isValid, String value, String errorMessage) throws Exception {
        ...
        jsonObjectAdd.put(ClientAddressLine2, value);
        if (isValid) {
