...
public class Auto_TC65609_Ohio_StaffPosition_Validation extends BaseTest

{
	...
	@Test(groups = {"All", "Regression","fixing"})
	@AdditionalInfo(module = "OhioStaff")
	public void Auto_TC_65609_Ohio_staffPosition_null() throws Exception
	{	
		// logger = extent.startTest("Auto_TC_65609_Ohio_staffPosition_null");
	...
	@Test(groups = {"All", "Regression","fixing"})
	@AdditionalInfo(module = "OhioStaff")
	public void Auto_TC_65609_Ohio_staffPosition_missing_value() throws Exception
	{	
		// logger = extent.startTest("Auto_TC_65609_Ohio_staffPosition_missing_value");

		logger.log(LogStatus.INFO, GlobalVariable_staff_v1.generateFieldValue );
		jsonField.put(GlobalVariable_staff_v1.staffPosition,"");
