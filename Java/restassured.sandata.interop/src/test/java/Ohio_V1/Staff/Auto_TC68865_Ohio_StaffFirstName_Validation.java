...
public class Auto_TC68865_Ohio_StaffFirstName_Validation extends BaseTest
{
	...
	public void Auto_TC_68865_Ohio_StaffFirstName_Valid_length() throws InterruptedException, java.text.ParseException, ClassNotFoundException, IOException, ParseException, SQLException
	{	
		// logger = extent.startTest("Auto_TC_68865_Ohio_StaffFirstName_Valid_length");
	...
	@Test(groups = {"All", "Regression","fixing"})
	@AdditionalInfo(module = "OhioStaff")
	public void Auto_TC_68865_Ohio_StaffFirstName_Valid_values() throws Exception
	{	
		// logger = extent.startTest("Auto_TC_68865_Ohio_StaffFirstName_Valid_values");

		logger.log(LogStatus.INFO, GlobalVariable_staff_v1.generateFieldValue );
		jsonField.put(GlobalVariable_staff_v1.staffFName, CommonMethods.generateRandomStringOfFixLength(5)+ " '.-");
	...
	@Test(groups = {"All", "Regression","fixing"})
	@AdditionalInfo(module = "OhioStaff")
	public void Auto_TC_68865_Ohio_StaffFirstName_invalid_length() throws Exception
	{	
		// logger = extent.startTest("Auto_TC_68865_Ohio_StaffFirstName_invalid_length");
	...
	@Test(groups = {"All", "Regression","fixing"})
	@AdditionalInfo(module = "OhioStaff")
	public void Auto_TC_68865_Ohio_StaffFirstName_null() throws Exception
	{	
		// logger = extent.startTest("Auto_TC_68865_Ohio_StaffFirstName_null");

		logger.log(LogStatus.INFO, GlobalVariable_staff_v1.generateFieldValue );
		jsonField.put(GlobalVariable_staff_v1.staffFName,null);

		logger.log(LogStatus.INFO, GlobalVariable_staff_v1.PostGetLog);
		Map<String, JSONObject> returnObject=dataGenerator.processOhioStaffV1(jsonField);

		logger.log(LogStatus.INFO, GlobalVariable_V1.errorVerify + GlobalVariable_staff_v1.staffFName);
		dataGenerator.assertFailErrorMessage(returnObject.get(GlobalVariable_staff_v1.bodyAsStringGet).toJSONString(), GlobalVariable_staff_v1.staffFirstNameNull);

	}

	@Test(groups = {"All", "Regression","fixing"})
	@AdditionalInfo(module = "OhioStaff")
	public void Auto_TC_68865_Ohio_StaffFirstName_missing_value() throws Exception
	{	
		// logger = extent.startTest("Auto_TC_68865_Ohio_StaffFirstName_invalid_length");
	...
	@Test(groups = {"All", "Regression","fixing"})
	@AdditionalInfo(module = "OhioStaff")
	public void Auto_TC_68865_Ohio_StaffFirstName_alphanumeric() throws Exception
	{	
		// logger = extent.startTest("Auto_TC_68865_Ohio_StaffFirstName_alphanumeric");

		logger.log(LogStatus.INFO, GlobalVariable_staff_v1.generateFieldValue );
		jsonField.put(GlobalVariable_staff_v1.staffFName,CommonMethods.generateRandomAlphaNumeric(10));
