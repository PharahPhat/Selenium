...
public class Auto_TC70203_Ohio_Visit_CallType_CallIn_Other_CallOut_Blank extends BaseTest{
	...
	public void TC70203_Ohio_Visit_CallType_CallIn_Other_CallOut_Blank() throws ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{

		// logger = extent.startTest("TC70203_Ohio_Visit_CallType_CallIn_Other_CallOut_Blank");
		...
		jsonField2.put(GlobalVariable_Ohio_Visit_v1.callTypejson, "" );
