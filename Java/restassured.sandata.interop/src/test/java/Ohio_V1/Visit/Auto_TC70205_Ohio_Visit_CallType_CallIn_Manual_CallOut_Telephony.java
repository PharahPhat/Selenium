...
public class Auto_TC70205_Ohio_Visit_CallType_CallIn_Manual_CallOut_Telephony extends BaseTest {
	...
	public void TC70205_Ohio_Visit_CallType_CallIn_Manual_CallOut_Telephony() throws ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		// logger = extent.startTest("TC70205_Ohio_Visit_CallType_CallIn_Manual_CallOut_Telephony");
		
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v1.generateFieldValue );
		jsonField1.put(GlobalVariable_Ohio_Visit_v1.callTypejson, "Manual" );
		jsonField2.put(GlobalVariable_Ohio_Visit_v1.callTypejson, "Telephony" );
