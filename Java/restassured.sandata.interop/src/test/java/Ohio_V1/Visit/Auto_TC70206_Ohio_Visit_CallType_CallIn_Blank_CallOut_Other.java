...
public class Auto_TC70206_Ohio_Visit_CallType_CallIn_Blank_CallOut_Other extends BaseTest {
	...
	public void TC70206_Ohio_Visit_CallType_CallIn_Blank_CallOut_Other() throws ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{

		// logger = extent.startTest("TC70206_Ohio_Visit_CallType_CallIn_Blank_CallOut_Other");

		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v1.generateFieldValue );
		jsonField1.put(GlobalVariable_Ohio_Visit_v1.callTypejson, "" );
