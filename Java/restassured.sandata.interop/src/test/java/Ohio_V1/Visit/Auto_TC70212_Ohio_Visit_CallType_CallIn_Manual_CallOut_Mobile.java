...
public class Auto_TC70212_Ohio_Visit_CallType_CallIn_Manual_CallOut_Mobile extends BaseTest{
	...
	public void TC70212_Ohio_Visit_CallType_CallIn_Manual_CallOut_Mobile() throws ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{

		// logger = extent.startTest("TC70212_Ohio_Visit_CallType_CallIn_Manual_CallOut_Mobile");
		...
		jsonField2.put(GlobalVariable_Ohio_Visit_v1.callTypejson, "Mobile" );
