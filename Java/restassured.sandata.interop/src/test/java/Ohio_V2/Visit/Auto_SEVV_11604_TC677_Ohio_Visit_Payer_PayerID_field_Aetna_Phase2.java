 ...
 *
 */
public class Auto_SEVV_11604_TC677_Ohio_Visit_Payer_PayerID_field_Aetna_Phase2 extends BaseTest{
	...
	public void TR677_Ohio_Visit_Payer_null_PayerID_field_Aetna_Phase2() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR677_Ohio_Visit_Payer_null_PayerID_field_Aetna_Phase2");
	...
	@Test(groups = {"All", "Regression"})
	public void TR677_Ohio_Visit_Payer_null_PayerID_field_Aetna_Phase2_invalid() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR677_Ohio_Visit_Payer_null_PayerID_field_Aetna_Phase2_invalid");
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v2.generateFieldValue );
	...
	@Test(groups = {"All", "Regression"})
	public void TR677_Ohio_Visit_Payer_PayerID_field_Aetna_Phase2_invalid() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
