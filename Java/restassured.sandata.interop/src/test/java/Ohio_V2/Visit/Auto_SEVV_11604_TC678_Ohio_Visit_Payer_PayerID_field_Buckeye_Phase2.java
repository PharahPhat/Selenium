 ...
 *
 */
public class Auto_SEVV_11604_TC678_Ohio_Visit_Payer_PayerID_field_Buckeye_Phase2 extends BaseTest{
	...
	public void TR678_Ohio_Visit_Payer_PayerID_field_Buckeye_Phase2() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR678_Ohio_Visit_Payer_PayerID_field_Buckeye_Phase2");
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v2.generateFieldValue );

		JSONArray arrayobj= new JSONArray();

		jsonField.put(GlobalVariable_Ohio_Visit_v2.Payer, "Buckeye");
		jsonField.put(GlobalVariable_Ohio_Visit_v2.PayerID, "Buckeye");
	...
	@Test(groups = {"All", "Regression"})
	public void TR678_Ohio_Visit_Payer_null_PayerID_field_Buckeye_Phase2() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR678_Ohio_Visit_Payer_null_PayerID_field_Buckeye_Phase2");
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v2.generateFieldValue );
	...
	@Test(groups = {"All", "Regression"})
	public void TR678_Ohio_Visit_Payer_PayerID_field_Buckeye_Phase2_invalid() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR678_Ohio_Visit_Payer_PayerID_field_Buckeye_Phase2_invalid");
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v2.generateFieldValue );
