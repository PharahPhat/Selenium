 ...
 *
 */
public class Auto_SEVV_11604_TC682_Ohio_Visit_Payer_PayerID_field_ODA_Phase2 extends BaseTest{
	...
	public void TR682_Ohio_Visit_Payer_PayerID_field_ODA_Phase2() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR682_Ohio_Visit_Payer_PayerID_field_ODA_Phase2");
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v2.generateFieldValue );

		JSONArray arrayobj= new JSONArray();

		jsonField.put(GlobalVariable_Ohio_Visit_v2.Payer, "ODA");
		jsonField.put(GlobalVariable_Ohio_Visit_v2.PayerID, "ODA");
		
		jsonField.put(GlobalVariable_Ohio_Visit_v2.PayerProgram, "PP");
	...
	@Test(groups = {"All", "Regression"})
	public void TR682_Ohio_Visit_Payer_null_PayerID_field_ODA_Phase2_invalid() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR682_Ohio_Visit_Payer_null_PayerID_field_ODA_Phase2_invalid");
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v2.generateFieldValue );
	...
	@Test(groups = {"All", "Regression"})
	public void TR682_Ohio_Visit_Payer_PayerID_field_ODA_Phase2_invalid() throws FileNotFoundException, ClassNotFoundException, InterruptedException, IOException, ParseException, SQLException, java.text.ParseException{
		
		{
		// logger = extent.startTest("TR682_Ohio_Visit_Payer_PayerID_field_ODA_Phase2_invalid");
		logger.log(LogStatus.INFO, GlobalVariable_Ohio_Visit_v2.generateFieldValue );
