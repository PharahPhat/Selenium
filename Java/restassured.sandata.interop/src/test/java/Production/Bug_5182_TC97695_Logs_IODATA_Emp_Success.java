...
GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam(); 
	...
	@Test
	public void Bug5182_TC97693_Logs_IODATA_Emp_Success_validation() throws IOException, ParseException, SQLException, java.text.ParseException, ClassNotFoundException, InterruptedException
	{
		...
		assertionDbVerifier.jsonAssert_iodata(bodyAsString, CommonMethods.capturegetIDonly(bodyAsStringget));
	}
