...
public class Bug3577_TC94737_ClientAddressLine1_ClientAddressline2_ClientCity_Hash extends BaseTest
{
	...
	public void Bug_3577_TC94731_ClientAddressLine1_ClientAddressline2_ClientCity_LongChar_valid() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, ClassNotFoundException, java.text.ParseException
	{
	...
	@Test(groups = {"All"})
	@AdditionalInfo(module = "OpenEVV")
	public void Bug_3577_TC94737_ClientAddressLine1_ClientAddressline2_ClientCity_Letter_valid() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, ClassNotFoundException, java.text.ParseException
	{
		// logger = extent.startTest("Bug_3577_TC94737_ClientAddressLine1_ClientAddressline2_ClientCity_letter_valid");
