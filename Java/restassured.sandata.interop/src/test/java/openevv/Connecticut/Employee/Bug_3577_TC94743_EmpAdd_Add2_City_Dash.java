 ...
 * @author MayankM
 */
// TC94745 : Inter-Op: Verifies if EmployeeAddress, EmployeeAddress2 & EmployeeCity fields are accepting values with -

public class Bug_3577_TC94743_EmpAdd_Add2_City_Dash extends BaseTest
{
	private GenerateUniqueParam GenerateUniqueParam=new GenerateUniqueParam();

	@Test(groups = {"All"})
	public void TC94743_EmpAdd_Add2_City_Dash_validation() throws Exception
	{
		// logger = extent.startTest("TC94743_EmpAdd_Add2_City_Dash_validation");
