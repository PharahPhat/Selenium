...
public class SEVV_2228_TC95418_Verify_AuthorizationWeekStart_field extends BaseTest {
	...
	public void TC95418_Verify_AuthorizationWeekStart_field_for_Invalid_character() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, Exception
	{
		...
		CommonMethods.verifyjsonassertFailcase(bodyAsString, globalVariables.AuthorizationweekstartnullerrorW);
		

}
	
	@Test(groups = {"All"})
	public void TC95418_Verify_AuthorizationWeekStart_field_for_Invalid_special_character() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, Exception
	{
		// // logger = extent.startTest("TC95418_Verify_AuthorizationWeekStart_field_for_Invalid_special_character");
		...
		JSONArray jsonArrPay = (JSONArray) jsonObject.get("AuthorizationLimit");
		JSONObject jsonObjectPay = 	(JSONObject) jsonArrPay.get(0);
		jsonObjectPay.put("AuthorizationWeekStart", CommonMethods.generateRandomStringOfFixLength(2)+'@');	
