...
public class SEVV_2228_TC95440_Verify_Modifier3_field_value extends BaseTest {
	...
	@Test(groups = {"All"})
	public void TC95440_Verify_Modifier3_field_value_invalid() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, Exception
	{
	...
	public void TC95440_Verify_Modifier3_field_value_invalid_morethan_allowed_length() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, Exception
	{
		...
		CommonMethods.verifyjsonassertFailcase(BodyAsStringGet, "Modifier3");
}
	@Test(groups = {"All"})
	public void TC95440_Verify_Modifier3_field_value_valid() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, Exception
	{
	...
	@Test(groups = {"All"})
	public void TC95440_Verify_Modifier3_field_value_valid_null() throws InterruptedException, java.text.ParseException,  IOException, ParseException, ConfigurationException, SQLException, Exception
	{
